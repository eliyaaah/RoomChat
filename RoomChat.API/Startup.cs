...
namespace RoomChat.API
{
    public class Startup
    {
        ...
        {
            Configuration = configuration; //inject settings from .json files
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env) //middleware
        {
            ...
            {
                app.UseDeveloperExceptionPage(); //return developer friendly excepction in developer mode
            }
            else
            {
            ...
            app.UseCors(x => x.AllowAnyOrigin().AllowAnyMethod().AllowAnyHeader()); //Add CORS 
